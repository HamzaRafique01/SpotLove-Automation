...
if(Mobile.waitForElementPresent(btn_editprofile, 10)) {
	...
	KeywordUtil.markPassed("Passed! EUser navigate to Edit Profile Screen.....")

	Mobile.callTestCase(findTestCase('Test Cases/Smoke/LookUps For Home/LookUps For Edit Profile/Edit Profile Setting'),
