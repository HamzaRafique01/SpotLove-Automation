...
if(Mobile.waitForElementPresent(btn_Continue, 10)) {
	...
	if(Mobile.waitForElementPresent(Only_this_time, 10)) {
		...
		KeywordUtil.markPassed("Passed! User Navigate GALLERY Screen......!")

	}else{
		KeywordUtil.markPassed("Failed To Navigate GALLERY Screen......!")
	}
}else {
	KeywordUtil.markPassed("Failed To Navigate Permission POPUP......!")
}
