...
//															KeywordUtil.markPassed("User Navigate to the Setting tab and Profile text found.......!")
															...
															if(Mobile.waitForElementPresent(btn_back, 10)) {
																...
																if(Mobile.waitForElementPresent(lbl_profile_H, 10)) {
