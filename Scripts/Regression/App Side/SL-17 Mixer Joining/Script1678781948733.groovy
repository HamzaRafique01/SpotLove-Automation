...
if(Mobile.waitForElementPresent(btn_RSVP, 120)) {
	...
	if(Mobile.waitForElementPresent(lbl_RSVP, 120)) {
		...
		KeywordUtil.markPassed("You RSVP'D for the next mixer lbl text found.......")
		...
		if(Mobile.waitForElementPresent(mixer_time, 120)) {
			...
			KeywordUtil.markFailed("You RSVP'D for the next mixer lbl text not found......")
		}
	}else {
		KeywordUtil.markFailed("You RSVP'D for the next mixer lbl text not found......")
	}
}else {
	KeywordUtil.markFailed("Mixer Banner not found......")
